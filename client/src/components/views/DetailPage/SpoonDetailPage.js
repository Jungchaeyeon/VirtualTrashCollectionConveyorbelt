...
function SpoonDetailPage() {
    ...
    const renderData = (data)=>{
      return (<p>
        ...
        <h4 className="content">분리배출 품목 : Spoon </h4>
    ...
    return (
        ...
        <Collapse className="panel" defaultActiveKey={['1']} onChange={callback}>
            <Panel header="실시간 Spoon 분리수거 현황" key="1">
               {renderData(data)}
            </Panel>
            <Panel header="일 별 Spoon 분리수거 현황" key="2">            
